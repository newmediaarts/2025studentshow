export default [
  {
    ...
    lastName: 'Abbey',
    url: 'gabby',
    image: 'img/gabby-abbey-studentimage.webp',
    hoverImage: 'img/gabby-abbey-studentimage-hover.webp',
    media: [
      {
        src: 'img/gabby-abbey-project1.webp',
        alt: 'Project 1',
        type: 'image',
      },
      {
        src: 'img/gabby-abbey-project2.webp',
        alt: 'Project 2',
        type: 'image',
      },
      {
        ...
        type: 'video',
        poster: 'img/gabby-abbey-project3-poster.webp',
      },
    ],
  ...
  },
  {
    ...
    media: [
      {
        src: 'img/katheren-lam-project1.webp',
        alt: 'Flower Knows',
        type: 'image',
      },
      {
        src: 'img/katheren-lam-project2.webp',
        alt: 'Fraufeuer',
        type: 'image',
      },
      {
        src: 'img/katheren-lam-project3.webp',
        alt: 'Secondstar',
        type: 'image',
      },
    ],
    portfolio: 'https://takyyttik.github.io/design/',
  },
  {
    name: 'Emmanuel',
    lastName: 'Correa',
    ...
    media: [
      {
        src: 'img/emmanual-correa-project1.webp',
        alt: 'LeaFruit',
        type: 'image',
      },
      {
        ...
        alt: 'TERGA',
        type: 'video',
        poster: 'img/emmanual-correa-project2-poster.webp',
      },
      {
    ...
    portfolio: 'https://www.emancor.com/',
  },
  {
    name: 'Emiri',
    lastName: 'Miyaji',
    ...
    media: [
      {
        src: 'img/emiri-miyaji-project01.webp',
        alt: 'Chok Dee',
        type: 'image',
      },
      {
        src: 'img/emiri-miyaji-project02.webp',
        alt: 'Sweet Tooth Dessert House',
        type: 'image',
      },
      {
        ...
        type: 'video',
        poster: 'img/emiri-miyaji-project03-poster.webp',
      },
    ],
  ...
  },
  {
    ...
    media: [
      {
        src: 'img/angelica-palilio-project1.webp',
        alt: 'Araw',
        type: 'image',
      },
      {
        src: 'img/angelica-palilio-project2.webp',
        alt: 'Cinque Terre',
        type: 'image',
      },
      {
        src: 'img/angelica-palilio-project3.webp',
        alt: 'Editorial',
        type: 'image',
      },
    ],
    portfolio: 'http://www.angelicapalilio.design',
    social: [
      {
        label: 'linkedin',
        url: 'https://www.linkedin.com/angelicapalilio/'
      },
    ]
  },
  {
    ...
    media: [
      {
        src: 'img/michaelfiocco-project1.webp',
      ...
      },
      {
        ...
        alt: 'Groov Donuts',
        type: 'video',
        poster: 'img/michaelfiocco-project2-poster.webp',
      },
      {
    ...
    portfolio: 'https://www.michaelfiocco.com/',
    social: [
      {
        label: 'linkedin',
        url: 'https://www.linkedin.com/in/michael-fiocco-900531214/'
      },
    ]
  },
  {
    ...
    media: [
      ...
      {
        src: 'img/HannaShibata-Project2.webp',
        alt: 'Musica Sake',
        type: 'image',
      },
      {
        ...
        type: 'video',
        poster: 'img/HannaShibata-Project3-poster.webp',
      },
    ],
